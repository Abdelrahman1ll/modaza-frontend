  ...
  return (
    <div className="relative w-full">
      ...
      <motion.div
        ...
        whileTap={{ scale: 0.98 }}
        className={`w-full py-3.5 rounded-2xl font-bold text-white shadow-lg transition-all flex items-center justify-center gap-3 pointer-events-none
        ${isLoading ? "bg-(--color-earth)/70" : "hover:shadow-xl"}`}
        style={{
