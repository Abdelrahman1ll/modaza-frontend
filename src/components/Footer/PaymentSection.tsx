...
export default function PaymentSection() {
  return (
    <div>
      ...
      <section className="max-w-7xl mx-auto px-4 bg-transparent">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          {paymentMethods.map((method, index) => (
            <div
              key={index}
              className="flex flex-col items-center text-center p-2 border border-gray-200 rounded-2xl shadow-sm hover:shadow-md transition-shadow"
            >
